...
# NTSTATUS value and code dict
# detail: https://msdn.microsoft.com/en-us/library/cc704588.aspx
NTSTATUS_CODES = {
...
NTSTATUS_DESC = {
 ...
 'STATUS_GRAPHICS_PVP_HFS_FAILED': "The function call failed because the display adapter's hardware functionality scan (HFS) failed to validate the graphics hardware.", 'STATUS_MAGAZINE_NOT_PRESENT': 'The specified element is contained in a magazine that is no longer present.',
 ...
 'STATUS_GRAPHICS_INVALID_PATH_CONTENT_GEOMETRY_TRANSFORMATION': "The specified VidPN's present path content geometry transformation is invalid.", 'STATUS_DUPLICATE_OBJECTID': 'The attempt to insert the ID in the index failed because the ID is already in the index.',
 ...
 'STATUS_CALLBACK_RETURNED_THREAD_AFFINITY': 'A threadpool worker thread entered a callback at thread affinity %p and exited at affinity %p.',
 ...
 'STATUS_GRAPHICS_TARGET_NOT_IN_TOPOLOGY': "The specified target is not part of the specified VidPN's topology.", 'STATUS_FVE_FS_NOT_EXTENDED': 'The file system does not extend to the end of the volume.',
 ...
 'STATUS_GRAPHICS_OPM_RESOLUTION_TOO_HIGH': "DxgkDdiOPMConfigureProtectedOutput() cannot enable the specified output protection technology because the output's screen resolution is too high.", 'STATUS_DEVICE_CONFIGURATION_ERROR': 'The I/O device is configured incorrectly or the configuration parameters to the driver are incorrect.',
 ...
 'STATUS_FT_READ_RECOVERY_FROM_BACKUP': u'{Redundant Read} To satisfy a read request, the Windows\xc2\xa0NT fault-tolerant file system successfully read the requested data from a redundant copy. This was done because the file system encountered a failure on a member of the fault-tolerant volume but was unable to reassign the failing area of the device.',
 ...
 'STATUS_GRAPHICS_SOURCE_NOT_IN_TOPOLOGY': "The specified source is not part of the specified VidPN's topology.", 'STATUS_VOLUME_MOUNTED': 'A new volume has been mounted by a file system.',
 ...
 'STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_DOES_NOT_HAVE_COPP_SEMANTICS': 'The DxgkDdiOPMGetCOPPCompatibleInformation, DxgkDdiOPMGetInformation, or DxgkDdiOPMConfigureProtectedOutput function failed. This error is returned only if a protected output has OPM semantics. ',
 ...
 'STATUS_GRAPHICS_MONITOR_NO_LONGER_EXISTS': "The operating system asynchronously destroyed the monitor that corresponds to this handle because the operating system's state changed. This error typically occurs because the monitor PDO associated with this handle was removed or stopped, or a display mode change occurred. A display mode change occurs when Windows sends a WM_DISPLAYCHANGE message to applications.", 'STATUS_GRAPHICS_PVP_INVALID_CERTIFICATE_LENGTH': 'A certificate could not be returned because the certificate buffer passed to the function was too small.',
 ...
 'STATUS_BAD_BINDINGS': "The client's supplied SSPI channel bindings were incorrect.", 'STATUS_GRAPHICS_PRESENT_UNOCCLUDED': 'Previous exclusive VidPn source owner has released its ownership',
 ...
 'STATUS_PROCESS_IS_PROTECTED': "Either the target process, or the target thread's containing process, is a protected process.", 'STATUS_MARSHALL_OVERFLOW': 'The user/kernel marshaling buffer has overflowed.',
 ...
 'STATUS_PRENT4_MACHINE_ACCOUNT': u'The machine account was created prior to Windows\xc2\xa0NT 4.0. The account needs to be recreated.',
 ...
 'STATUS_CSS_RESETS_EXHAUSTED': u'Copy protection error\xe2\x80\x94The region setting of the drive may be permanent.',
 ...
 'STATUS_CSS_KEY_NOT_PRESENT': u'Copy protection error\xe2\x80\x94The specified sector does not contain a valid key.',
 ...
 'STATUS_DS_SRC_SID_EXISTS_IN_FOREST': "The source object's SID already exists in destination forest.", 'STATUS_INVALID_ACE_CONDITION': 'The specified access control entry (ACE) contains an invalid condition.',
 ...
 'STATUS_CTX_CLIENT_LICENSE_NOT_SET': 'Your request to connect to this ',
 ...
 'STATUS_CALLBACK_RETURNED_LDR_LOCK': 'A threadpool worker thread entered a callback, which left the loader lock held.',
 'STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_CHECKSUM': "This error occurred because the value in a DDC/CI message's checksum field did not match the message's computed checksum value. This error implies that the data was corrupted while it was being transmitted from a monitor to a computer.", 'STATUS_PURGE_FAILED': 'The attempt to purge this file from memory failed to purge some or all the data from memory.',
 ...
 'STATUS_CALLBACK_RETURNED_TRANSACTION': 'A threadpool worker thread entered a callback, which left transaction state.',
 ...
 'STATUS_CALLBACK_RETURNED_THREAD_PRIORITY': 'A threadpool worker thread entered a callback at thread base priority 0x%x and exited at priority 0x%x.',
 ...
 'STATUS_FLT_NO_WAITER_FOR_REPLY': "No waiter is present for the filter's reply to this message.", 'STATUS_BAD_NETWORK_PATH': 'The network path cannot be located.',
 ...
 'STATUS_SYNCHRONIZATION_REQUIRED': u'The SAM database on a Windows\xc2\xa0Server is significantly out of synchronization with the copy on the domain controller. A complete synchronization is required.',
 ...
 'STATUS_CSS_KEY_NOT_ESTABLISHED': u'Copy protection error\xe2\x80\x94DVD session key not established.',
 ...
 'STATUS_INVALID_IMPORT_OF_NON_DLL': "A dynamic link library (DLL) referenced a module that was neither a DLL nor the process's executable image.", 'STATUS_ACCOUNT_LOCKED_OUT': 'The user account has been automatically locked because too many invalid logon attempts or password change attempts have been requested.',
 ...
 'STATUS_CSS_AUTHENTICATION_FAILURE': u'Copy protection error\xe2\x80\x94DVD CSS Authentication failed.',
 ...
 'STATUS_MONITOR_INVALID_SERIAL_NUMBER_MONDSC_BLOCK': "The provided monitor descriptor block is either corrupted or does not contain the monitor's detailed serial number.", 'STATUS_SXS_PROCESS_TERMINATION_REQUESTED': 'A component used by the isolation facility has requested that the process be terminated.',
 ...
 'STATUS_GRAPHICS_CANCEL_VIDPN_TOPOLOGY_AUGMENTATION': "The miniport requested that augmentation be canceled for the specified source of the specified VidPN's topology.", 'STATUS_POWER_STATE_INVALID': 'The power state of the current device cannot support this request.',
 'STATUS_CSS_SCRAMBLED_SECTOR': u'Copy protection error\xe2\x80\x94The read failed because the sector is encrypted.',
 ...
 'STATUS_GRAPHICS_PATH_NOT_IN_TOPOLOGY': "The specified present path is not in the VidPN's topology.", 'STATUS_INVALID_PRIMARY_GROUP': 'Indicates a particular security ID may not be assigned as the primary group of an object.',
 ...
 'STATUS_MEMBERS_PRIMARY_GROUP': "Indicates a member cannot be removed from a group because the group is currently the member's primary group.", 'STATUS_DS_GC_NOT_AVAILABLE': 'Unable to contact the global catalog server.',
 ...
 'STATUS_NOTIFY_ENUM_DIR': "Indicates that a notify change request is being completed and that the information is not being returned in the caller's buffer. The caller now needs to enumerate the files to find the changes.", 'STATUS_SXS_ACTIVATION_CONTEXT_DISABLED': 'The application attempted to activate a disabled activation context.',
 ...
 'STATUS_GRAPHICS_OPM_ALL_HDCP_HARDWARE_ALREADY_IN_USE': "DxgkDdiOPMConfigureProtectedOutput() cannot enable HDCP because other physical outputs are using the display adapter's HDCP hardware.", 'STATUS_LOG_BLOCK_VERSION': 'The log service encountered an invalid log block version.',
 ...
 'STATUS_DOMAIN_CTRLR_CONFIG_ERROR': u'A Windows\xc2\xa0Server has an incorrect configuration.',
 ...
 'STATUS_GRAPHICS_PINNED_MODE_MUST_REMAIN_IN_SET': "The pinned mode must remain in the set on the VidPN's co-functional modality enumeration.", 'STATUS_MONITOR_UNKNOWN_DESCRIPTOR_FORMAT': 'This release does not support the format of the obtained monitor descriptor.',
 ...
 'STATUS_GRAPHICS_PARTIAL_DATA_POPULATED': 'The specified buffer is not big enough to contain the entire requested dataset. Partial data is populated up to the size of the buffer.',
 ...
 'STATUS_CSS_REGION_MISMATCH': u'Copy protection error\xe2\x80\x94The region of the specified DVD does not correspond to the region setting of the drive.',
 ...
 'STATUS_NO_TRUST_SAM_ACCOUNT': u'The SAM database on the Windows\xc2\xa0Server does not have a computer account for this workstation trust relationship.',
 ...
 'STATUS_LOG_GROWTH_FAILED': "An attempt to create space in the transactional resource manager's log failed. The failure status has been recorded in the event log.", 'STATUS_LOG_RECORD_NONEXISTENT': 'The log record is not a record in the log file.',
 ...
 'STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_DOES_NOT_HAVE_OPM_SEMANTICS': 'The DxgkDdiOPMGetCOPPCompatibleInformation, DxgkDdiOPMGetInformation, or DxgkDdiOPMConfigureProtectedOutput function failed. This error is returned only if a protected output has COPP semantics. ',
 ...
 'STATUS_CALLBACK_RETURNED_LANG': 'A threadpool worker thread entered a callback, which left with preferred languages set.',
 ...
 'STATUS_GRAPHICS_PATH_ALREADY_IN_TOPOLOGY': "The specified video present path is already in the VidPN's topology.", 'STATUS_GRAPHICS_OPM_SESSION_TYPE_CHANGE_IN_PROGRESS': 'OPM functions cannot be called when a session is changing its type. Three types of sessions currently exist: console, disconnected, and remote (RDP or ICA).',
 ...
 'STATUS_OFFLOAD_READ_FILE_NOT_SUPPORTED': 'Offload read operations cannot be performed on:',
 ...
 'STATUS_FT_WRITE_RECOVERY': u'{Redundant Write} To satisfy a write request, the Windows\xc2\xa0NT fault-tolerant file system successfully wrote a redundant copy of the information. This was done because the file system encountered a failure on a member of the fault-tolerant volume but was unable to reassign the failing area of the device.',
 ...
 'STATUS_GRAPHICS_INVALID_PATH_IMPORTANCE_ORDINAL': "The specified VidPN's present path importance ordinal is invalid.", 'RPC_NT_STRING_TOO_LONG': 'The string is too long.',
 ...
 'STATUS_GRAPHICS_NO_RECOMMENDED_VIDPN_TOPOLOGY': "The miniport has no recommendation for augmenting the specified VidPN's topology.", 'RPC_NT_UNKNOWN_AUTHN_SERVICE': 'The authentication service is unknown.',
 'STATUS_NOT_SUPPORTED_ON_SBS': u'This operation is not supported on a computer running Windows Server\xc2\xa02003 for Small Business Server.',
 ...
 'STATUS_WAS_UNLOCKED': "{Page Unlocked} The page protection of a locked page was changed to 'No Access' and the page was unlocked from memory and from the process.", 'STATUS_TXF_ATTRIBUTE_CORRUPT': 'The transactional metadata attribute on the file or directory %hs is corrupt and unreadable.',
 ...
 'STATUS_SXS_FILE_HASH_MISMATCH': "A component's file does not match the verification information present in the component manifest.", 'STATUS_GRAPHICS_MAX_NUM_PATHS_REACHED': 'The maximum supported number of present paths has been reached.',
 ...
 'STATUS_OFFLOAD_WRITE_FILE_NOT_SUPPORTED': 'Offload write operations cannot be performed on:',
 ...
 'STATUS_CALLBACK_RETURNED_PRI_BACK': 'A threadpool worker thread entered a callback, which left with background priorities set.',
...
# detail: https://msdn.microsoft.com/en-us/library/ee441884.aspx
SMB_ERR_CLASSES = {
    '0x00': 'SUCCESS_CLASS', 
    '0x01': 'ERRDOS_CLASS', 
    '0x02': 'ERRSRV_CLASS',
...
ERRDOS_CLASS_CODES = {
'0x03FE': 'More changes have occurred within the directory than will fit within the specified Change Notify response buffer.',
 '0x011A': 'The server file system does not support Extended Attributes.',
 '0x0050': 'An attempt to create a file or directory failed because an object with the same pathname already exists.',
 '0x0032': 'This command is not supported by the server.',
 '0x0057': 'A parameter supplied with the message is invalid.',
 '0x000F': 'Invalid drive specified.',
 '0x000D': 'Bad data. (May be generated by IOCTL calls on the server.)',
 '0x000B': 'Invalid format.',
 '0x000C': 'Invalid open mode.',
 '0x000A': 'Invalid environment.',
 '0x0113': 'Either there are no extended attributes, or the available extended attributes did not fit into the response.',
 '0x010A': 'The copy functions cannot be used.',
 '0x00AE': 'The file system does not support atomic changes to the lock type.',
 '0x00AD': 'No lock request was outstanding for the supplied cancel region.',
 '0x0011': 'A file system operation (such as a rename) across two devices was attempted.',
 '0x0010': 'Remove of directory failed because it was not empty.',
 '0x0012': 'No (more) files found following a file search command.',
 '0x00EA': 'There is more data available to read on the designated named pipe.',
 '0x03E2': 'Access to the extended attribute was denied.',
 '0x009E': 'The byte range specified in an unlock request was not locked.',
 '0x00E7': 'All instances of the designated named pipe are busy.',
 '0x00E6': 'Invalid named pipe.',
 '0x00E9': 'The designated named pipe exists, but there is no server process listening on the server side.',
 '0x00E8': 'The designated named pipe is in the process of being closed.',
 '0x0071': 'Maximum number of searches has been exhausted.',
 '0x001F': 'General error.',
 '0x0008': 'Insufficient server memory to perform the requested operation.',
 '0x0009': 'The server performed an invalid memory access (invalid address).',
 '0x0006': 'Invalid FID.',
 '0x0007': 'Memory Control Blocks were destroyed.',
 '0x0004': 'Too many open files. No FIDs are available.',
 '0x0005': 'Access denied.',
 '0x0002': 'File not found.',
 '0x0003': 'A component in the path prefix is not a directory.',
 '0x0026': 'Attempted to read beyond the end of the file.',
 '0x0001': 'Invalid Function.',
 '0x0020': 'Sharing violation. A requested open mode conflicts with the sharing mode of an existing file handle.',
 '0x0083': 'An attempt was made to seek to a negative absolute offset within a file.',
 '0x0021': 'A lock request specified an invalid locking mode, or conflicted with an existing file lock.',
 '0x007C': 'Invalid information level.',
 '0x00FF': 'Inconsistent extended attribute list.'
}

ERRSRV_CLASS_CODES = {
'0xFFFF': 'Function not supported by the server.',
 '0x0034': 'Invalid FID for print file.',
 '0x0033': 'End Of File on print queue dump.',
 '0x0032': 'Print queue is full - no space for queued item, or queued item too big.',
 '0x0031': 'Print queue is full - too many queued items.',
 '0x0059': 'No resources currently available for this SMB request.',
 '0x0058': 'Operation timed out.',
 '0x08C2': "The user's password has expired.", '0x08C1': 'Access to the server is not permitted at this time.',
 '0x08C0': 'The client does not have permission to access this server.',
 '0x08BF': 'User account on the target machine is disabled or has expired.',
 '0x0016': 'An unknown SMB command code was received by the server.',
 '0x0011': 'A command with matching MID or SequenceNumber is currently being processed. This error code is defined only when the Direct IPX connectionless transport is in use.',
 '0x0010': 'Invalid Connection ID (CID). This error code is only defined when the Direct IPX connectionless transport is in use.',
 '0x0012': 'Incorrect NetBIOS Called Name when starting an SMB session over Direct IPX. This error code is only defined when the Direct IPX connectionless transport is in use.',
 '0x00E9': 'Write to a named pipe with no reader.',
 '0x0043': 'The FID and pathname contain incompatible values.',
 '0x0040': 'Unrecognized SMB command code.',
 '0x0041': 'Internal server error.',
 '0x0047': 'The attribute mode presented in a set mode request was invalid.',
 '0x0045': 'An invalid combination of access permissions for a file or directory was presented. The server cannot set the requested attributes.',
 '0x005A': 'Too many UIDs active for this SMB ',
 '0x005B': 'The UID specified is not known as a valid ID on this server session.',
 '0x0006': 'Invalid server name in Tree Connect.',
 '0x0007': 'A printer request was made to a non-printer device or, conversely, a non-printer request was made to a printer device.',
 '0x0004': 'Access denied. The specified UID does not have permission to execute the requested command within the current context (TID).',
 '0x0005': 'The TID specified in the command was invalid.',
 '0x0002': 'Invalid password.',
 '0x0003': 'DFS pathname not on local server.',
 '0x0001': 'Unspecified server error.',
 '0x00FA': 'Temporarily unable to support RAW mode transfers. Use MPX mode.',
 '0x00FB': 'Temporarily unable to support RAW or MPX mode transfers. Use standard read/write.',
 '0x00FC': 'Continue in MPX mode.'
}

ERRHRD_CLASS_CODES = {
'0x0023': 'No server-side File Control Blocks are available to process the request.',
 '0x0019': 'Seek error.',
 '0x0018': 'Bad request structure length.',
 '0x0015': 'Drive not ready.',
 '0x0014': 'Unknown unit.',
 '0x0017': 'Data error (incorrect CRC).',
 '0x0016': 'Unknown command.',
 '0x0024': 'A sharing buffer has been exceeded.',
 '0x0013': 'Attempt to modify a read-only file system.',
 '0x0027': 'No space on file system.',
 '0x0020': 'An attempted open operation conflicts with an existing open.',
 '0x0021': 'A lock request specified an invalid locking mode, or conflicted with an existing file lock.',
 '0x001E': 'Read fault.',
 '0x001D': 'Write fault.',
 '0x001F': 'General hardware failure.',
 '0x001A': 'Unknown media type.',
 '0x0022': 'The wrong disk was found in a drive.',
 '0x001C': 'Printer out of paper.',
